...
insert into words values (DEFAULT,"Achiever","Determined","They are determined to do whatever it takes to achieve results."),
...
(DEFAULT,"Ideation","Free-Thinker","They enjoy thinking outside the box to come up with fresh ideas and approaches."),
...
(DEFAULT,"Maximizer","Coaching","They love to help others become excited about their potential and focus on areas of strengths."),
...
(DEFAULT,"Significance","Visible","They enjoy being seen and known for their unique talents."),
